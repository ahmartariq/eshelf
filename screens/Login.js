  ...
  return (
    <View
      ...
      <TouchableOpacity
        ...
        <Text style={{color: colors.text, fontFamily: 'rg'}}>
          Forgot Password?
        </Text>
      </TouchableOpacity>
      <Button
      ...
      <View style={{alignItems: 'center', marginTop: 16}}>
        <View style={{flexDirection: 'row'}}>
          <TouchableOpacity activeOpacity={0.7}>
            <SvgXml xml={facebookSVG} style={{marginHorizontal: 5}} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.7}>
            <SvgXml xml={twitterSVG} style={{marginHorizontal: 5}} />
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.7}>
            <SvgXml xml={instagramSVG} style={{marginHorizontal: 5}} />
          </TouchableOpacity>
        </View>
      </View>
      <View
