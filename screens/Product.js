    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <View style={{width: '100%', height: 600}}>
        <Swiper
          ...
          dotStyle={{width: 6, height: 6, marginRight: 4}}
          activeDotStyle={{borderWidth: 1, borderColor: colors.background}}
          paginationStyle={{
          ...
          <View>
            <Image
              source={require('../assets/pics/pic1.png')}
              style={{width: '100%', height: 600}}
            />
          </View>
          <View>
            <Image
              source={require('../assets/pics/pic2.png')}
              style={{width: '100%', height: 600}}
            />
          </View>
          <View>
            <Image
              source={require('../assets/pics/pic3.png')}
              style={{width: '100%', height: 600}}
            />
          </View>
          <View>
            <Image
              source={require('../assets/pics/pic4.png')}
              style={{width: '100%', height: 600}}
            />
          </View>
          <View>
            <Image
              source={require('../assets/pics/pic5.png')}
              style={{width: '100%', height: 600}}
            />
          </View>
        </Swiper>
      ...
      <TouchableOpacity
        ...
        <Text
          ...
          OVERSIZED CYBER GRAPHIC HOODED SWEATSHIRT
        </Text>
        <Text
          style={{
            fontSize: 20,
        ...
        <Text
          ...
          80% COTTON, 20% POLYESTER MACHINE WASH UP TO 30C/86F, GENTLE CYCLE DO
          NOT BLEACH IRON UP TO 110C/230F DO NOT IRON DIRECTLY ON
          PRINTS/EMBROIDERY/EMBELLISHMENTS DO NOT DRY CLEAN DO NOT TUMBLE DRY{' '}
        </Text>
